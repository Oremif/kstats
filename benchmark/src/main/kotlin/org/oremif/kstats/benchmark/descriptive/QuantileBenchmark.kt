...
class QuantileBenchmark {
    ...
    @Param("1000", "10000", "100000") var size: Int = 0
    ...
    @Benchmark fun kstatsPercentile50(): Double = data.percentile(50.0)

    @Benchmark fun commonsPercentile50(): Double = commonsPercentile.evaluate(data, 50.0)

    // --- 95th percentile ---

    @Benchmark fun kstatsPercentile95(): Double = data.percentile(95.0)

    @Benchmark fun commonsPercentile95(): Double = commonsPercentile.evaluate(data, 95.0)

    // --- IQR ---

    @Benchmark fun kstatsIqr(): Double = data.interquartileRange()
