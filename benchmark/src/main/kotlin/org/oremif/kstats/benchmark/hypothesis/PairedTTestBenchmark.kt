...
class PairedTTestBenchmark {
    ...
    @Benchmark fun kstatsPairedTTest(): TestResult = pairedTTest(sample1, sample2)

    @Benchmark fun commonsPairedTTest(): Double = commonsTTest.pairedTTest(sample1, sample2)
}
