...
class ContinuousDistributionBenchmark {
    ...
    @Benchmark
    fun commonsStudentTQuantile(): Double = cStudentT.inverseCumulativeProbability(pValue)
    ...
    @Benchmark
    fun commonsExponentialQuantile(): Double = cExponential.inverseCumulativeProbability(pValue)
}
