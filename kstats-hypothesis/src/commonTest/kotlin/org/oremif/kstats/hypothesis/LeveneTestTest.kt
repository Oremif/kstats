...
class LeveneTestTest : AbstractVarianceTestTest() {
    ...
    fun defaultCenterIsMedian() {
        ...
        val medianResult =
            leveneTest(TestData.LOW_VARIANCE, TestData.HIGH_VARIANCE, center = LeveneCenter.MEDIAN)
    ...
    @Test
    fun fiveGroupsMean() {
        // scipy: levene([1..5], [2,4,6,8,10], [1,3,5,7,9], [3,6,9,12,15], [0.5,1,1.5,2,2.5],
        // center='mean')
    ...
    fun minimumSize2x2() {
        ...
        assertTrue(
            ...
            "W should be infinite when ssWithin=0 and ssBetween>0",
        )
    ...
    override fun unequalGroupSizes() {
        // scipy: levene([1,2,3], [4,5,6,7,8], center='mean') → (0.923076923076923,
        // 0.373770542585760)
    ...
    fun constantGroupsMedian() {
        val result =
            leveneTest(TestData.CONSTANT_3x3, TestData.CONSTANT_7x3, center = LeveneCenter.MEDIAN)
    ...
    fun largeSamplesVeryDifferentVariances() {
        val result =
            leveneTest(
                TestData.largeSmallSpread(),
                TestData.largeLargeSpread(),
                center = LeveneCenter.MEAN,
            )
    ...
    fun nanInGroupMedian() {
        val result =
            leveneTest(TestData.WITH_NAN, TestData.SEQUENTIAL_6_10, center = LeveneCenter.MEDIAN)
