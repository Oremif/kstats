 ...
 *
 * The alternative hypothesis is the claim being tested against the null hypothesis. The choice of
 * alternative affects how the p-value is computed from the test statistic.
 */
public enum class Alternative {
    /**
     * Tests whether the parameter differs from the null value in either direction.
     *
     * This is the most common choice and is appropriate when you have no prior expectation about
